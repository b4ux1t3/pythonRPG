...
# This is just a list of the goblins in this particular field.
...
# Adding "peek" to both their ability lists

gob1.abilities.append(Ability(1))
gob2.abilities.append(Ability(1))

gob1.abilities[0].peek(gob2)
gob2.abilities[0].peek(gob1)
